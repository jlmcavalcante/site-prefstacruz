    ...
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="space-y-8">
        <div className="border rounded-lg p-6 shadow-md">
          <h3 className="text-2xl font-semibold mb-2 text-black">Festa da Invenção da Santa Cruz</h3>
          <p className="text-lg text-black mb-4">Maio</p>
        ...
        <div className="border rounded-lg p-6 shadow-md">
          <h3 className="text-2xl font-semibold mb-2 text-black">Festa da Exaltação da Santa Cruz</h3>
          <p className="text-lg text-black mb-4">Setembro</p>
          <p className="text-black">
        ...
        <div className="border rounded-lg p-6 shadow-md">
          <h3 className="text-2xl font-semibold mb-2 text-black">Encontro dos Santos</h3>
          <p className="text-lg text-black mb-4">Novembro</p>
          <p className="text-black">
