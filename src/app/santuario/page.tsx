...
export default function SantuarioPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      <h1 className="text-4xl font-bold text-center mb-8 text-black">Santuário de Santa Cruz dos Milagres</h1>

      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4 text-black">Horários de Missas e Celebrações</h2>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4 text-black">Nossa História</h2>
      ...
      <section>
        <h2 className="text-2xl font-bold mb-4 text-black">Galeria de Fotos</h2>
