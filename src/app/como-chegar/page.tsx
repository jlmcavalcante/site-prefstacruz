export default function ComoChegarPage() {
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <h2 className="text-3xl font-bold text-center mb-8 text-black">Principais Rotas</h2>

      <div className="space-y-8">
        <section>
          <h3 className="text-2xl font-semibold mb-4 text-black">Vindo de Teresina</h3>
        ...
        <section>
          <h3 className="text-2xl font-semibold mb-4 text-black">Vindo de Floriano</h3>
          <p className="text-black leading-relaxed">
